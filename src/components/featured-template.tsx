...
export function FeaturedTemplate({ name, slug, description, type: _, category, labels }: FeaturedTemplateProps) {
  return (
    <Card className="flex flex-col overflow-hidden border-primary/10 transition-all duration-300 group gradient-border-subtle hover-raise elevation-low hover:elevation-md bg-card/80 backdrop-blur">
